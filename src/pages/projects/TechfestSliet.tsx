...
const TechfestSliet = () => {
  const portfolioItems = [
    "/lovable-uploads/5da153ca-daf3-4ff4-8b85-2d85905930f4.png"
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="py-8 px-4 sm:px-6 lg:px-8 border-b border-primary/20">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <h1 className="text-2xl font-bold text-foreground">Techfest'25 SLIET</h1>
        </div>
      </header>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <div className="inline-block px-4 py-2 bg-primary/20 rounded-full">
                  <span className="text-primary font-semibold">Event Branding</span>
                </div>
                <h2 className="text-4xl md:text-5xl font-black text-foreground">
                  TECHFEST'25 <span className="gradient-text">SLIET</span>
                </h2>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Dynamic logo and event branding design for Techfest'25 at SLIET. 
                  Created a modern, tech-inspired visual identity that captures the innovation 
                  and energy of this premier technical festival, featuring geometric patterns 
            ...
            <div className="relative">
              <div className="project-card">
                <div className="text-center text-white space-y-4 p-8">
                  <h3 className="text-xl font-bold">TECHFEST'25 SLIET</h3>
                  <div className="bg-white/10 rounded-xl p-4">
                    <div className="text-lg font-semibold text-green-400">SLIET</div>
                    <div className="text-sm">TECHFEST 2025</div>
                  </div>
            ...
            {portfolioItems.map((item, index) => (
              <Card key={index} className="overflow-hidden">
                <CardContent className="p-0">
                  <img 
                    src={item} 
                    alt={`Techfest SLIET Design ${index + 1}`}
