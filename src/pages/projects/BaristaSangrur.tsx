...
const BaristaSangrur = () => {
  const portfolioItems = [
    "/lovable-uploads/78a21dce-3b5e-4a9c-a76d-c31532230870.png"
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="py-8 px-4 sm:px-6 lg:px-8 border-b border-primary/20">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <h1 className="text-2xl font-bold text-foreground">Barista Sangrur</h1>
        </div>
      </header>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <div className="inline-block px-4 py-2 bg-primary/20 rounded-full">
                  <span className="text-primary font-semibold">Coffee Brand Design</span>
                </div>
                <h2 className="text-4xl md:text-5xl font-black text-foreground">
                  BARISTA <span className="gradient-text">SANGRUR</span>
                </h2>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  <li>• Coffee Brand Identity</li>
                  <li>• Product Packaging Design</li>
                  <li>• Logo & Visual Elements</li>
            ...
            <div className="relative">
              <div className="project-card">
                <div className="text-center text-white space-y-4 p-8">
                  <h3 className="text-xl font-bold">BARISTA SANGRUR</h3>
                  <div className="bg-white/10 rounded-xl p-4">
                    <div className="text-lg font-semibold text-orange-400">BARISTA</div>
                    <div className="text-sm">Premium Coffee Experience</div>
                  </div>
            ...
            {portfolioItems.map((item, index) => (
              <Card key={index} className="overflow-hidden">
                <CardContent className="p-0">
                  <img 
                    src={item} 
                    alt={`Barista Sangrur Design ${index + 1}`}
